...
const AttendanceSummary = () => {
  ...
  const fetchAttendanceData = async () => {
    try {
      ...
      if (parentError || !parentUserData || !parentUserData.students || parentUserData.students.length === 0) {
        console.log('AttendanceSummary - No parent/student data found, using sample data');
        ...
        console.log('AttendanceSummary - Using real student data:', studentDetails.name);
      }
