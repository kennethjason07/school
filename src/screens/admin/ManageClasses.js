    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              // Check if there are students in this class using schema
              ...
              if (studentsError) {
                console.error('Error checking students in class:', studentsError);
                Alert.alert('Error', 'Failed to check students in class');
                return;
              }
              ...
              // 1. Delete all subjects for this class using schema
              ...
              // 2. Delete timetable entries for this class using schema
              ...
              // 3. Delete the class using schema-based query
